...
SESSION_SEARCH_GUIDANCE = (
    ...
    "them to repeat themselves. If the user asks for a report/summary of a prior "
    "run/test and did not provide a file path, run session_search first instead "
    "of starting with filesystem-only searches."
)
